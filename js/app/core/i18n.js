...
const translations = {
  en: {
    ...
    permBlockedHint: '⚠️ Camera or location is blocked in the browser. Tap the lock icon in the address bar (or browser settings → site permissions), allow Camera & Location, then try again.',
  ...
  ar: {
    ...
    permBlockedHint: '⚠️ الكاميرا أو الموقع محظوران في المتصفح. اضغط على رمز القفل في شريط العنوان (أو إعدادات المتصفح ← أذونات الموقع)، واسمح بالكاميرا والموقع، ثم حاول مرة أخرى.',
